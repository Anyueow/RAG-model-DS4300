...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('rag_generation_qdrant.log'),
...
class ResponseGenerator:
    """Generate evaluation responses using different RAG configurations with Qdrant DB."""
    ...
    def generate_responses(self) -> None:
        ...
        logger.info("Starting response generation with Qdrant DB...")
        ...
        for config in self.configurations:
            ...
            try:
                ...
                if not os.path.exists(self.data_dir / "processed_qdrant"):
                    logger.info("Processing documents...")
                    rag.ingest_documents(str(self.data_dir))
                    (self.data_dir / "processed_qdrant").touch()
    ...
    def generate_summary(self) -> None:
        ...
        # Save summary
        with open(self.results_dir / "summary_qdrant.json", 'w') as f:
            json.dump(summary, f, indent=2)
        
        logger.info(f"Summary saved to {self.results_dir}/summary_qdrant.json")

def main():
    parser = argparse.ArgumentParser(description='Generate evaluation responses for RAG system with Qdrant DB')
